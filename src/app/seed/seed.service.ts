  ...
  private async seedProjects(): Promise<void> {
    ...
    const projects = this.projectsRepository.create([
      ...
      },
      {
        name: 'arkadion-web',
        slug: 'arkadion-web',
        description: 'Arkadion AI assistant UI: chat with 21 personas and local models.',
        repoUrl: 'https://github.com/PatlixStudio/arkadion-web',
        status: ProjectStatus.IN_PROGRESS,
        tags: ['angular', 'ai', 'chat'],
      },
      {
        name: 'arkadion-api',
        slug: 'arkadion-api',
        description: 'Arkadion NestJS backend: entities, chat (WebSocket), LLM chain and speech.',
        repoUrl: 'https://github.com/PatlixStudio/arkadion-api',
        status: ProjectStatus.IN_PROGRESS,
        tags: ['nestjs', 'postgres', 'typeorm', 'ai', 'speaches'],
      },
      {
        name: 'ai-dashboard',
        slug: 'ai-dashboard',
